...
def init_model():
    ...
    # 加载预训练权重
    ckp = 'model/base_model_215M/pretrain_1024_18_8192.pth'
    state_dict = torch.load(ckp, map_location=args.device)
    # [NOTE] 唯一看不懂的就是这一步在做什么？排除一些组件不进行sft？
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out_dir", type=str, default="model/sft_model_215M", help="输出目录")
    ...
    parser.add_argument("--data_path", type=str, default="data/BelleGroup_sft.jsonl", help="训练数据路径")
